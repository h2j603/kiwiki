...
- [에코루프 (EchoLoop)](echoloop.md): 에코루프의 반복적 사고 패턴이 고스트핑의 확인 강박과 결합하면 증상이 기하급수적으로 악화된다.
- [팬텀탭 (PhantomTab)](phantomtab.md): 팬텀탭이 생성하는 유령 탭들이 고스트핑 감염자에게 추가 알림 소스로 작용할 수 있다.
- [애프터이미지 (AfterImage)](afterimage.md): 검색엔진 벡터를 공유하며, 고스트핑의 팬텀 알림이 애프터이미지의 잔상과 중첩되는 사례가 보고됨.
{: .ko}

- [EchoLoop](echoloop.md): When EchoLoop's repetitive thought patterns combine with GhostPing's verification compulsion, symptoms worsen exponentially.
- [PhantomTab](phantomtab.md): The ghost tabs generated by PhantomTab can serve as additional notification sources for GhostPing-infected individuals.
