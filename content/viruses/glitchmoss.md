...
- [미러링크 (MirrorLink)](mirrorlink.md): 미러링크 말기 환자 주변의 반사면에서 글리치모스와 유사한 부식이 관찰된 사례가 있다.
{: .ko}

- [CacheVein](cachevein.md): A fellow Environmental-type virus. While GlitchMoss corrodes spaces, CacheVein inscribes physical traces of data. Spaces where both viruses coexist are extremely dangerous.
- [SyntaxWraith](syntaxwraith.md): Shares the Direct Access transmission vector. While GlitchMoss comes from abandoned pages, SyntaxWraith originates from neglected code repositories.
